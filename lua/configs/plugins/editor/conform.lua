return function()
	...
	conform.setup({
		formatters_by_ft = {
			...
			zig = safe("zigfmt"),
			-- codespell deliberately NOT on ["*"]: it spawns an extra process on
			-- every single save for every filetype, and rewrites identifiers it
			-- mistakes for typos. Run it on demand with :ConformInfo / manually.
